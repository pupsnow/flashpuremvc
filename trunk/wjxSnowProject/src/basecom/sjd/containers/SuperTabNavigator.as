...
package  basecom.sjd.containers
{
	...
	import basecom.sjd.controls.tabBarClasses.SuperTab;
	import basecom.sjd.controls.ScrollableArrowMenu;
	import basecom.sjd.controls.ScrollableMenu;
	import basecom.sjd.controls.SuperTabBar;
	import basecom.sjd.events.TabReorderEvent;
	import basecom.sjd.skins.TabPopUpButtonSkin;
	...
	public class SuperTabNavigator extends TabNavigator
	{
	    ...
	    */
                                                  ...
                                                  unscaledHeight:Number):void
	    {
	        ...
	        holder.move(0, 1);
	        //  holder.move(0, unscaledHeight-th); 这样显示在下面。
