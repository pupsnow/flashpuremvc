...
[RemoteClass(alias="flex.graphics.ImageSnop")]
...
public  class ImageSnop
{
    ...
    [Bindable]
    public static var isOk:Boolean = true;
    //--------------------------------------------------------------------------
    //
    //  Class variables
    // 
     ...
     *  The default is true.
     *
     *  @return An ImageSnop holding an encoded captured snapshot
    ...
    public static function captureImage(
                                ...
                                scaleLimited:Boolean = true):ImageSnop
    {
        var snapshot:ImageSnop;
        ...
        try
        {
            ...
            snapshot = new ImageSnop(width, height, bytes,
                                         encoder.contentType);
        }
        finally
        {
     ...
     */
    public function ImageSnop(width:int = 0, height:int = 0,
                                  data:ByteArray = null,
     ...
     *  only when sending an ImageSnop instance
