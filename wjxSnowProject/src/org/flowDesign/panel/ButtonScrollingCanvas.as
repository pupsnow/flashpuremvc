package   org.flowDesign.panel
{
	...
	public class ButtonScrollingCanvas extends Canvas
	{
		...
		public static var DEFAULT_BUTTON_WIDTH:Number = 25;
		...
		override protected function createChildren():void {
			...
			// on our own
			innerCanvas = new HBox();
		  innerCanvas.setStyle("verticalAlign","middle");
		   innerCanvas.setStyle("horizontalAlign","center");
	    ...
	    public function stopScrolling(event:Event):void {
	    	if(timer.running) {
				timer.stop();
			}
	    }
		...
		public function scrollUp(event:TimerEvent):void {
	    	innerCanvas.verticalScrollPosition -= scrollJump;
	    	enableOrDisableButtons();
	    }
	    
	    public function scrollDown(event:TimerEvent):void {
			innerCanvas.verticalScrollPosition += scrollJump;
			enableOrDisableButtons();
		}
