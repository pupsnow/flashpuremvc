                       ...
                       IFocusManagerComponent, IListItemRenderer
{
    ...
    public static function stringToDate(valueString:String, inputFormat:String):Date
    {
		...
		var HHNum:Number=Number(HHString);
		var FFNum:Number=Number(FFString);
		var SSNum:Number=Number(SSString);
        ...
        var newDate:Date = new Date(yearNum, monthNum - 1, dayNum,HHNum,FFNum,SSNum);
     ...
     *
     *  @example <pre>var todaysDate:String = DateField.dateToString(new Date(), "MM/DD/YYYY HH:FF:SS");</pre>
     */
   public static function dateToString(value:Date,HH:String,MM:String,SS:String, outputFormat:String):String
		{
				 if (!value)
	            return "";
     ...
     */
    private var _dropdown:DateTimeChooser;
     ...
     */
    public function get dropdown():DateTimeChooser
    {
        return _dropdown;
    }
     ...
     */
    private var _parseFunction:Function = DateTimeField.stringToDate;
     ...
     */
	[Embed(source="dateChooser/DateTimeField.swf",symbol="openDateOver")]
    ...
    override protected function createChildren():void
    {
        ...
        downArrowButton.setStyle("disabledSkin", disabledSkin);
        downArrowButton.setStyle("downSkin", downSkin);
        downArrowButton.setStyle("overSkin", overSkin);
        downArrowButton.setStyle("upSkin", upSkin);
    ...
    override protected function commitProperties():void
    {
		...
		if (timeEnabledChanged)
        {
            ...
            dropdown.timeEnabled = _timeEnabled;
    ...
    override protected function measure():void
    {
        ...
        var txt:String = (_labelFunction != null) ? _labelFunction(bigDate) : 
                            dateToString(bigDate,"00","00","00",formatString);
  ...
  /*   override public function styleChanged(styleProp:String):void
    ...
    private function displayDropdown(show:Boolean, triggerEvent:Event = null):void
    {
        ...
        _dropdown.removeEventListener(FlexMouseEvent.MOUSE_DOWN_OUTSIDE,
                                   dropdown_mouseDownOutsideHandler);
        if (!_enabled)
            return;
        ...
        if (show)
        {
            ...
            var dd:DateTimeChooser = dropdown;
    ...
    private function createDropdown():void
    {
        ...
        _dropdown.focusEnabled = true;
        _dropdown.tabChildren=true;
        _dropdown.tabEnabled=true;
        ...
        _dropdown.displayedYear = todaysDate.getFullYear();
		 ...
		 var dropdownStyleName:Object = getStyle("dateChooserStyleName");
            //if (!dropdownStyleName)
             //   dropdownStyleName = this;
       ...
       _dropdown.addEventListener(FlexEvent.CREATION_COMPLETE,addFun);
        creatingDropdown = false;
    }
		/**
		 * 给时分秒添加监听 
		 *   */
	   private function addFun(e:FlexEvent):void
	   {
	   	if(_dropdown.time!=null)
		   	{
		   _dropdown.time.addEventListener("hoursChange",DateChange);
		   _dropdown.time.addEventListener("minutesChange",DateChange);
		   _dropdown.time.addEventListener("secondsChange",DateChange);
		   	}
	   }
    ...
    private function dateFiller(value:Date):void
    {
        ...
        else if(dropdown.time!=null)
            textInput.text = dateToString(value,dropdown.time.hours.toString(),dropdown.time.minutes.toString(),dropdown.time.seconds.toString(), formatString);
   		else if(value==null)
   			 textInput.text="";
   		else
   		    textInput.text=dateToString(value,value.getHours().toString(),value.getMinutes().toString(),value.getSeconds().toString(),formatString);
